      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900 ">
       ...
       <nav className="py-10 flex justify-between ">
        ...
        <div className="text-center">
          ...
          Freelancer providing services for programming and design content needs. Join me down below and let is get cracking! 
          </p>
        </div>
        ...
        <div className="relative bg-gradient-to-b from-teal-500 rounded-full mx-auto w-80 h-80 mt-20 overflow-hidden md:w-96 md:h-96">
          <Image src={avatar} layout="fill" objectFit="cover" alt="" ></Image>
        </div>
       </section>
{/* ==================================================== */}
       <section>
